...
<div class="section section-dark section-bg-leafs {{$bgColor}}" id="contact-us-banner">
...
<div id="contact-us-banner-sentinel" class="section section-dark section-bg-leafs {{$bgColor}}">
  <div class="container text-center">
    <h3 class="section-title">Come ti possiamo aiutare?</h3>
