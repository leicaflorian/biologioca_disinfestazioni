                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'service_id'">{{ trans('admin.contact.columns.service_id') }}</th>
                                        <th is='sortable' :column="'phone'">{{ trans('admin.contact.columns.phone') }}</th>
                                        <th is='sortable' :column="'message'">{{ trans('admin.contact.columns.message') }}</th>
