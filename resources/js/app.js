...
(function () {
  const banner = document.getElementById('contact-us-banner')
  const bannerSentinel = document.getElementById('contact-us-banner-sentinel')
  const btnGoUp = document.querySelector('.go-up-btn')
